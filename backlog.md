...
User Story X-1: AI Agent (MCP) can autonomously book rooms [See GitLab Issue #49]

REQ-R-7: External API endpoint for third-party integrations [See GitLab Issue #50]
